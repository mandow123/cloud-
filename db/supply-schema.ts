/** Isolated supply inventory schema. It intentionally does not mutate exchange tables. */
export const SUPPLY_SCHEMA_VERSION = 2;

export const supplySchemaStatements = [
