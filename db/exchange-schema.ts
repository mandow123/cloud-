...
export const exchangeSeedStatements = [
  `INSERT OR IGNORE INTO exchange_product_versions (
    ...
    ('PV-GPU-RTX4090-PCIE-24GB', 'GPU_COMPUTE', 'GPU_HOUR', 'NVIDIA GeForce RTX 4090 24GB', 'NVIDIA', 'RTX 4090 24GB', 'PCIe', '{"memoryGiB":24,"architecture":"Ada Lovelace","consumerGpu":true}', 'gpu:nvidia:rtx4090-24gb:pcie:v1', '2026-08-11T00:00:00.000Z'),
  ...
  `INSERT OR IGNORE INTO exchange_product_capacity_policies (
    ...
    ('PCP-GPU-RTX4090-PCIE-24GB-V1', 'PV-GPU-RTX4090-PCIE-24GB', 'gpu-rtx4090-pcie-24gb-v1', 'GPU_COMPUTE', 'GPU', 'GPU_ALLOCATION',
      'GPU_HOUR', 1, 1, 'GPU', 3600, 'ENABLED', '{"identity":"GPU_PRODUCT_VERSION","capacityBaseUnit":"GPU_SECOND","consumerGpu":true}', 'policy:gpu:rtx4090-pcie-24gb:v1', '2026-08-11T00:00:00.000Z'),
