...
const messages = {
  ...
  "zh-TW": {
    language: "語言", languageLabel: "選擇語言", theme: "顯示模式", system: "跟隨系統", light: "淺色", dark: "深色", buy: "購買算力", request: "提交算力需求",
  ...
  en: {
    language: "Language", languageLabel: "Select language", theme: "Appearance", system: "System", light: "Light", dark: "Dark", buy: "Buy compute", request: "Submit demand",
  ...
  ja: {
    language: "言語", languageLabel: "言語を選択", theme: "表示", system: "システム", light: "ライト", dark: "ダーク", buy: "計算資源を購入", request: "需要を提出",
  ...
  ko: {
    language: "언어", languageLabel: "언어 선택", theme: "화면 모드", system: "시스템", light: "라이트", dark: "다크", buy: "컴퓨팅 구매", request: "수요 제출",
  ...
  fr: {
    language: "Langue", languageLabel: "Choisir la langue", theme: "Affichage", system: "Système", light: "Clair", dark: "Sombre", buy: "Acheter du calcul", request: "Soumettre un besoin",
  ...
  th: {
    language: "ภาษา", languageLabel: "เลือกภาษา", theme: "รูปแบบหน้าจอ", system: "ตามระบบ", light: "สว่าง", dark: "มืด", buy: "ซื้อพลังประมวลผล", request: "ส่งความต้องการ",
  ...
  vi: {
    language: "Ngôn ngữ", languageLabel: "Chọn ngôn ngữ", theme: "Giao diện", system: "Theo hệ thống", light: "Sáng", dark: "Tối", buy: "Mua năng lực tính toán", request: "Gửi nhu cầu",
  ...
  id: {
    language: "Bahasa", languageLabel: "Pilih bahasa", theme: "Tampilan", system: "Sistem", light: "Terang", dark: "Gelap", buy: "Beli komputasi", request: "Ajukan kebutuhan",
  ...
  ms: {
    language: "Bahasa", languageLabel: "Pilih bahasa", theme: "Paparan", system: "Ikut sistem", light: "Cerah", dark: "Gelap", buy: "Beli pengkomputeran", request: "Hantar keperluan",
