...
const messages = {
  "zh-CN": {
    language: "导航语言",
    languageLabel: "选择导航语言",
    languageScope: "业务内容仍以中文为准",
    theme: "显示模式",
    system: "跟随系统",
    light: "浅色",
    dark: "深色",
  ...
  "zh-TW": {
    language: "導覽語言", languageLabel: "選擇導覽語言", languageScope: "業務內容仍以中文為準", theme: "顯示模式", system: "跟隨系統", light: "淺色", dark: "深色", buy: "購買算力", request: "提交算力需求",
  ...
  en: {
    language: "Navigation", languageLabel: "Select navigation language", languageScope: "Business content remains in Chinese", theme: "Appearance", system: "System", light: "Light", dark: "Dark", buy: "Buy compute", request: "Submit demand",
  ...
  ja: {
    language: "ナビ言語", languageLabel: "ナビゲーション言語を選択", languageScope: "業務コンテンツは中国語のままです", theme: "表示", system: "システム", light: "ライト", dark: "ダーク", buy: "計算資源を購入", request: "需要を提出",
  ...
  ko: {
    language: "탐색 언어", languageLabel: "탐색 언어 선택", languageScope: "비즈니스 콘텐츠는 중국어로 유지됩니다", theme: "화면 모드", system: "시스템", light: "라이트", dark: "다크", buy: "컴퓨팅 구매", request: "수요 제출",
  ...
  fr: {
    language: "Langue du menu", languageLabel: "Choisir la langue de navigation", languageScope: "Le contenu métier reste en chinois", theme: "Affichage", system: "Système", light: "Clair", dark: "Sombre", buy: "Acheter du calcul", request: "Soumettre un besoin",
  ...
  th: {
    language: "ภาษาเมนู", languageLabel: "เลือกภาษาของเมนู", languageScope: "เนื้อหาธุรกิจยังคงเป็นภาษาจีน", theme: "รูปแบบหน้าจอ", system: "ตามระบบ", light: "สว่าง", dark: "มืด", buy: "ซื้อพลังประมวลผล", request: "ส่งความต้องการ",
  ...
  vi: {
    language: "Ngôn ngữ menu", languageLabel: "Chọn ngôn ngữ điều hướng", languageScope: "Nội dung nghiệp vụ vẫn bằng tiếng Trung", theme: "Giao diện", system: "Theo hệ thống", light: "Sáng", dark: "Tối", buy: "Mua năng lực tính toán", request: "Gửi nhu cầu",
  ...
  id: {
    language: "Bahasa menu", languageLabel: "Pilih bahasa navigasi", languageScope: "Konten bisnis tetap dalam bahasa Tionghoa", theme: "Tampilan", system: "Sistem", light: "Terang", dark: "Gelap", buy: "Beli komputasi", request: "Ajukan kebutuhan",
  ...
  ms: {
    language: "Bahasa menu", languageLabel: "Pilih bahasa navigasi", languageScope: "Kandungan perniagaan kekal dalam bahasa Cina", theme: "Paparan", system: "Ikut sistem", light: "Cerah", dark: "Gelap", buy: "Beli pengkomputeran", request: "Hantar keperluan",
