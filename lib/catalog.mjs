...
export const STATIC_SAMPLE_DATA_CLASS = "STATIC_SAMPLE";
export const MARKET_REFERENCE_DATA_CLASS = "MARKET_REFERENCE";
...
function createQuote({
  ...
  return Object.freeze({
    dataClass: MARKET_REFERENCE_DATA_CLASS,
    currency: "CNY",
    pricingUnit,
    rangeMin,
    rangeMax,
...
function createListing(definition) {
  ...
  return Object.freeze({
    ...definition,
    dataClass: STATIC_SAMPLE_DATA_CLASS,
