export type ExchangeErrorCode =
  ...
  | "HOSTING_TERMS_POLICY_UNAVAILABLE"
  | "HOSTING_AGENT_UPGRADE_REQUIRED"
  | "HOSTING_PHYSICAL_GPU_REQUIRED"
  | "HOSTING_INSTANCE_EVIDENCE_MISSING"
  | "HOSTING_ACCEPTANCE_EVIDENCE_MISSING"
  | "HOSTING_ACCEPTANCE_WINDOW_ACTIVE"
  | "HOSTING_ACCEPTANCE_WINDOW_EXPIRED"
  | "HOSTING_DELIVERY_FAILURE_INVALID"
  | "HOSTING_DELIVERY_FAILURE_REFUND_REQUIRED"
  | "HOSTING_STOP_FAILURE_INVALID"
