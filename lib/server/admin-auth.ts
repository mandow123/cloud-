...
const ROLE_PERMISSIONS: Readonly<Record<AdminRole, readonly AdminPermission[]>> = {
  ...
  FINANCE_OPERATOR: ["ADMIN_PANEL_READ", "PAYMENT_READ", "APPEAL_READ", "OFFLINE_REFUND_RECORD", "AUDIT_READ"],
  FINANCE_APPROVER: ["ADMIN_PANEL_READ", "PAYMENT_READ", "SETTLEMENT_OPERATE", "APPEAL_READ", "OFFLINE_REFUND_VERIFY", "AUDIT_READ"],
