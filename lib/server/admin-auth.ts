...
const ROLE_PERMISSIONS: Readonly<Record<AdminRole, readonly AdminPermission[]>> = {
  ...
  MARKET_OPERATOR: [],
  FULFILLMENT_OPERATOR: ["ADMIN_PANEL_READ", "FULFILLMENT_READ", "FULFILLMENT_OPERATE", "APPEAL_READ", "APPEAL_HANDLE", "AUDIT_READ"],
  FINANCE_OPERATOR: ["ADMIN_PANEL_READ", "PAYMENT_READ", "REFUND_REQUEST", "APPEAL_READ", "OFFLINE_REFUND_RECORD", "AUDIT_READ"],
  FINANCE_APPROVER: ["ADMIN_PANEL_READ", "PAYMENT_READ", "SETTLEMENT_OPERATE", "REFUND_APPROVE", "APPEAL_READ", "OFFLINE_REFUND_VERIFY", "AUDIT_READ"],
  SUPPORT_READONLY: ["ADMIN_PANEL_READ", "SUPPORT_READ", "APPEAL_READ"],
  AUDITOR: [],
};
