...
const adminItemLabels = {
  ...
  "/admin/managed-gpu": { "zh-CN": "GPU 云托管", "zh-TW": "GPU 雲託管", en: "GPU cloud hosting", ja: "GPU クラウドホスティング", ko: "GPU 클라우드 호스팅", fr: "Hébergement cloud GPU", th: "โฮสติ้ง GPU บนคลาวด์", vi: "Lưu trữ GPU đám mây", id: "Hosting cloud GPU", ms: "Pengehosan awan GPU" },
