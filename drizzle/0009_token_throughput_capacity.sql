-- M6-A3: enable canonical Token throughput accounting without legacy-unit contamination.
...
CREATE TABLE exchange_m9_guard (
  label TEXT PRIMARY KEY,
  ok INTEGER NOT NULL CHECK (ok = 1)
);
--> statement-breakpoint

CREATE TABLE exchange_m9_shadow_capacity_lots AS
SELECT
...
CREATE TABLE exchange_m9_shadow_listing_versions AS
SELECT
...
CREATE TABLE exchange_m9_shadow_orders AS
SELECT
...
CREATE TABLE exchange_m9_shadow_reservations AS
SELECT
...
CREATE TABLE exchange_m9_shadow_capacity_transfers AS
SELECT
...
CREATE TABLE exchange_m9_shadow_metering_sessions AS
SELECT
...
CREATE TABLE exchange_m9_shadow_service_facts AS
SELECT
...
CREATE TABLE exchange_m9_shadow_metering_finals AS
SELECT
...
INSERT INTO exchange_m9_guard(label, ok)
SELECT 'capacity_lots_backfill', CASE WHEN NOT EXISTS (
  SELECT 1 FROM exchange_m9_shadow_capacity_lots
  WHERE capacity_base_units <> rate_units * (unixepoch(end_at) - unixepoch(start_at))
    OR NOT (
      ...
      OR (rate_unit_code IN ('MODEL_INSTANCE', 'MILLI_M_TOKEN_PER_HOUR')
...
SELECT 'listing_versions_backfill', CASE WHEN NOT EXISTS (
  SELECT 1 FROM exchange_m9_shadow_listing_versions
...
SELECT 'orders_backfill', CASE WHEN NOT EXISTS (
  SELECT 1 FROM exchange_m9_shadow_orders
  WHERE typeof(unit_price_micros) <> 'integer'
...
SELECT 'reservations_backfill', CASE WHEN NOT EXISTS (
  SELECT 1 FROM exchange_m9_shadow_reservations
  WHERE capacity_base_units <> rate_units * (unixepoch(end_at) - unixepoch(start_at))
    OR NOT (
      (rate_unit_code = 'GPU' AND capacity_gpu_seconds = capacity_base_units AND parallel_units = rate_units)
      OR (rate_unit_code IN ('MODEL_INSTANCE', 'MILLI_M_TOKEN_PER_HOUR')
...
SELECT 'metering_sessions_backfill', CASE WHEN NOT EXISTS (
  SELECT 1 FROM exchange_m9_shadow_metering_sessions
...
CREATE TABLE IF NOT EXISTS exchange_capacity_lots (
  ...
  accounting_schema_version INTEGER NOT NULL DEFAULT 3 CHECK (accounting_schema_version IN (1, 2, 3)),
...
INSERT INTO exchange_capacity_lots SELECT * FROM exchange_m9_shadow_capacity_lots;
--> statement-breakpoint
INSERT INTO exchange_listing_versions SELECT * FROM exchange_m9_shadow_listing_versions;
--> statement-breakpoint
INSERT INTO exchange_orders SELECT * FROM exchange_m9_shadow_orders;
--> statement-breakpoint
INSERT INTO exchange_reservations SELECT * FROM exchange_m9_shadow_reservations;
--> statement-breakpoint
INSERT INTO exchange_capacity_transfers SELECT * FROM exchange_m9_shadow_capacity_transfers;
--> statement-breakpoint
INSERT INTO exchange_metering_sessions SELECT * FROM exchange_m9_shadow_metering_sessions;
--> statement-breakpoint
INSERT INTO exchange_service_facts SELECT * FROM exchange_m9_shadow_service_facts;
--> statement-breakpoint
INSERT INTO exchange_metering_finals SELECT * FROM exchange_m9_shadow_metering_finals;
--> statement-breakpoint
...
SELECT 'capacity_lots_roundtrip', CASE WHEN
  NOT EXISTS (SELECT * FROM exchange_m9_shadow_capacity_lots EXCEPT SELECT * FROM exchange_capacity_lots)
  AND NOT EXISTS (SELECT * FROM exchange_capacity_lots EXCEPT SELECT * FROM exchange_m9_shadow_capacity_lots)
THEN 1 ELSE 0 END;
--> statement-breakpoint
INSERT INTO exchange_m9_guard(label, ok)
SELECT 'listing_versions_roundtrip', CASE WHEN
  NOT EXISTS (SELECT * FROM exchange_m9_shadow_listing_versions EXCEPT SELECT * FROM exchange_listing_versions)
  AND NOT EXISTS (SELECT * FROM exchange_listing_versions EXCEPT SELECT * FROM exchange_m9_shadow_listing_versions)
THEN 1 ELSE 0 END;
--> statement-breakpoint
INSERT INTO exchange_m9_guard(label, ok)
SELECT 'orders_roundtrip', CASE WHEN
  NOT EXISTS (SELECT * FROM exchange_m9_shadow_orders EXCEPT SELECT * FROM exchange_orders)
  AND NOT EXISTS (SELECT * FROM exchange_orders EXCEPT SELECT * FROM exchange_m9_shadow_orders)
THEN 1 ELSE 0 END;
--> statement-breakpoint
INSERT INTO exchange_m9_guard(label, ok)
SELECT 'reservations_roundtrip', CASE WHEN
  NOT EXISTS (SELECT * FROM exchange_m9_shadow_reservations EXCEPT SELECT * FROM exchange_reservations)
  AND NOT EXISTS (SELECT * FROM exchange_reservations EXCEPT SELECT * FROM exchange_m9_shadow_reservations)
THEN 1 ELSE 0 END;
--> statement-breakpoint
INSERT INTO exchange_m9_guard(label, ok)
SELECT 'capacity_transfers_roundtrip', CASE WHEN
  NOT EXISTS (SELECT * FROM exchange_m9_shadow_capacity_transfers EXCEPT SELECT * FROM exchange_capacity_transfers)
  AND NOT EXISTS (SELECT * FROM exchange_capacity_transfers EXCEPT SELECT * FROM exchange_m9_shadow_capacity_transfers)
THEN 1 ELSE 0 END;
--> statement-breakpoint
INSERT INTO exchange_m9_guard(label, ok)
SELECT 'metering_sessions_roundtrip', CASE WHEN
  NOT EXISTS (SELECT * FROM exchange_m9_shadow_metering_sessions EXCEPT SELECT * FROM exchange_metering_sessions)
  AND NOT EXISTS (SELECT * FROM exchange_metering_sessions EXCEPT SELECT * FROM exchange_m9_shadow_metering_sessions)
THEN 1 ELSE 0 END;
--> statement-breakpoint
INSERT INTO exchange_m9_guard(label, ok)
SELECT 'service_facts_roundtrip', CASE WHEN
  NOT EXISTS (SELECT * FROM exchange_m9_shadow_service_facts EXCEPT SELECT * FROM exchange_service_facts)
  AND NOT EXISTS (SELECT * FROM exchange_service_facts EXCEPT SELECT * FROM exchange_m9_shadow_service_facts)
THEN 1 ELSE 0 END;
--> statement-breakpoint
INSERT INTO exchange_m9_guard(label, ok)
SELECT 'metering_finals_roundtrip', CASE WHEN
  NOT EXISTS (SELECT * FROM exchange_m9_shadow_metering_finals EXCEPT SELECT * FROM exchange_metering_finals)
  AND NOT EXISTS (SELECT * FROM exchange_metering_finals EXCEPT SELECT * FROM exchange_m9_shadow_metering_finals)
THEN 1 ELSE 0 END;
--> statement-breakpoint
...
DROP TABLE exchange_m9_shadow_metering_finals;
--> statement-breakpoint
DROP TABLE exchange_m9_shadow_service_facts;
--> statement-breakpoint
DROP TABLE exchange_m9_shadow_metering_sessions;
--> statement-breakpoint
DROP TABLE exchange_m9_shadow_capacity_transfers;
--> statement-breakpoint
DROP TABLE exchange_m9_shadow_reservations;
--> statement-breakpoint
DROP TABLE exchange_m9_shadow_orders;
--> statement-breakpoint
DROP TABLE exchange_m9_shadow_listing_versions;
--> statement-breakpoint
DROP TABLE exchange_m9_shadow_capacity_lots;
--> statement-breakpoint
DROP TABLE exchange_m9_guard;
--> statement-breakpoint
